...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("xdeskbin".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../xdesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\xdesk\flutter\build\windows\runner\Debug\ -o . -e ..\xdesk\flutter\build\windows\runner\Debug\xdesk.exe
